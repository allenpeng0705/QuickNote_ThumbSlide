...
-(void)handleOrientationChang:(BOOL)aToLandscape
{
    ...
    if (aToLandscape == YES) {
        iInputView.iKeyboardView.iWidthRatio = 102400/320.0;
        iInputView.iKeyboardView.iHeightRatio = 30400/208.0;
        frame.origin.x = 320;
        frame.size.width = 1024;
        frame.size.height = 384;
    } else {
        iInputView.iKeyboardView.iWidthRatio = 76800/320.0;
        iInputView.iKeyboardView.iHeightRatio = 30400/208.0; 
...
{    
	if ((self = [super initWithFrame:frame])) {
        ...
        textFrame.origin.y = frame.size.height - textFrame.size.height - 100;
        ...
        changeKeyboard(ime, (char*)[layout UTF8String]);
